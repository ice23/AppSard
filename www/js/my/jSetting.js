...
$('#Setting').live('pageshow', function (event, ui) {
    ...
    if (localStorage.getItem('Position') != null) {
        ...
        if (Position == 'AUTO') {
            ...
            $("label[for='radio-mini-1']").removeClass("ui-radio-off").addClass("ui-radio-on");
            $("label[for='radio-mini-2']").removeClass("ui-radio-on").addClass("ui-radio-off");
        }
        else {
            //alert('MANUAL');
            $("label[for='radio-mini-2']").removeClass("ui-radio-off").addClass("ui-radio-on");
            $("label[for='radio-mini-1']").removeClass("ui-radio-on").addClass("ui-radio-off");
        }
    }
    ...
    if (localStorage.getItem('Lang') != null) {
        ...
        if (Lang == 'ITA') {
            ...
            $("label[for='radioITA']").removeClass("ui-radio-off").addClass("ui-radio-on");
            $("label[for='radioEN']").removeClass("ui-radio-on").addClass("ui-radio-off");
        }
        if (Lang == 'EN') {
            //alert('MANUAL');
            $("label[for='radioEN']").removeClass("ui-radio-off").addClass("ui-radio-on");
            $("label[for='radioITA']").removeClass("ui-radio-on").addClass("ui-radio-off");
        }
    }
});
...
//        }
    ...
    $('#radioITA').change(function () {
        if ($("#radioITA").attr("checked")) {
            localStorage.setItem('Lang', 'ITA');
            SetLabel();
        }
    });

    $('#radioEN').change(function () {
        if ($("#radioEN").attr("checked")) {
